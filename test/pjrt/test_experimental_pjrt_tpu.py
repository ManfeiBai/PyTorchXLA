  ...
  def test_xla_devices_multiprocess(self):
    accelerator_devices = {
        ...
        'v5litepod-128': {
            ...
            8: torch.device('xla:0'),
            9: torch.device('xla:0'),
            10: torch.device('xla:0'),
            11: torch.device('xla:0'),
            12: torch.device('xla:0'),
            13: torch.device('xla:0'),
            14: torch.device('xla:0'),
            15: torch.device('xla:0'),
            16: torch.device('xla:0'),
            17: torch.device('xla:0'),
            18: torch.device('xla:0'),
            19: torch.device('xla:0'),
            20: torch.device('xla:0'),
            21: torch.device('xla:0'),
            22: torch.device('xla:0'),
            23: torch.device('xla:0'),
            24: torch.device('xla:0'),
            25: torch.device('xla:0'),
            26: torch.device('xla:0'),
            27: torch.device('xla:0'),
            28: torch.device('xla:0'),
            29: torch.device('xla:0'),
            30: torch.device('xla:0'),
            31: torch.device('xla:0'),
        },
    }
